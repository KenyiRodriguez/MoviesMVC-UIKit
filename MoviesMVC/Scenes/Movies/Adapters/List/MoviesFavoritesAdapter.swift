...
class MoviesFavoritesAdapter: NSObject, MoviesCollectionViewAdapter {
    ...
    func setCollectionView(_ collectionView: UICollectionView) {
        ...
        self.collectionView?.register(MovieFavoriteCollectionViewCell.self, forCellWithReuseIdentifier: MovieFavoriteCollectionViewCell.identifier)
...
extension MoviesFavoritesAdapter {
...
extension MoviesFavoritesAdapter: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let movie = item as? Movie {
            return MovieFavoriteCollectionViewCell.buildIn(collectionView, indexPath: indexPath, movie: movie)
...
extension MoviesFavoritesAdapter: UICollectionViewDelegate {
